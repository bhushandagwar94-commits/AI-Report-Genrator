...
import { List, Plus, FileText } from "@phosphor-icons/react";
              ...
              <div className="flex-grow flex flex-col min-w-[235px] min-h-0">
                <div className="relative h-[calc(100%-60px)] flex flex-col w-full justify-between pt-[10px] overflow-y-scroll no-scroll">
                  <div className="flex flex-col gap-y-[14px]">
                    ...
                    <Link
                      to={paths.reports()}
                      className="flex items-center gap-x-3 py-[10px] px-3 bg-theme-sidebar-item-default hover:bg-[#FFF]/10 light:hover:bg-[#000]/10 border border-white/5 rounded-xl transition-all duration-300"
                    >
              ...
              <div className="h-auto md:sidebar-items">
                <div className=" flex flex-col gap-y-4 overflow-y-scroll no-scroll pb-[60px]">
                  ...
                  <Link
                    to={paths.reports()}
                    onClick={() => setShowSidebar(false)}
                    className="flex items-center gap-x-3 py-[10px] px-3 bg-[#000]/10 border border-white/5 rounded-xl transition-all duration-300"
                  >
                    <FileText className="h-5 w-5 text-theme-text-secondary" />
                    <span className="text-sm font-semibold text-theme-text-primary">
                      Report Generator
