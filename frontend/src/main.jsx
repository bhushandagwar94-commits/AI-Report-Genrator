...
const router = createBrowserRouter([
  {
    ...
    children: [
      ...
      },
      {
        path: "/reports",
        lazy: async () => {
          const { default: PublicReports } = await import("@/pages/Reports/Public");
          return { element: <PrivateRoute Component={PublicReports} /> };
        },
      },
      {
        path: "/login",
      ...
      },
      {
        ...
        lazy: async () => {
          const { default: AdminReports } = await import("@/pages/Reports/Admin");
          return { element: <AdminRoute Component={AdminReports} /> };
        },
      },
      {
